 ...
 *
 * Variante con sfondo BLU solido (come /breeds).
 * SENZA logo nel header.
 *
 * SLOTS DISPONIBILI:
 ...
 */
@Component({
  selector: 'app-tab-page-shell-blue',
  standalone: true,
  imports: [
    CommonModule,
  ...
  templateUrl: './tab-page-shell-blue.component.html',
  styleUrls: ['./tab-page-shell-blue.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class TabPageShellBlueComponent {
  /** Titolo pagina */
  @Input() title = '';
